...
import 'year_result_model.dart';
export 'year_result_model.dart';

class YearResultWidget extends StatefulWidget {
  const YearResultWidget({
    super.key,
    required this.year,
  });
  ...
  @override
  State<YearResultWidget> createState() => _YearResultWidgetState();
}

class _YearResultWidgetState extends State<YearResultWidget>
    with TickerProviderStateMixin {
  late YearResultModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => YearResultModel());
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '0ak7t8rc' /* Tasks to be completed */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .labelMedium
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '6d8kqjws' /* Tasks to be completed */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .labelMedium
