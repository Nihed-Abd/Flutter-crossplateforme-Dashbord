...
import 'add_withdrawal_model.dart';
export 'add_withdrawal_model.dart';

class AddWithdrawalWidget extends StatefulWidget {
  const AddWithdrawalWidget({
    super.key,
    required this.title,
  });
  ...
  @override
  State<AddWithdrawalWidget> createState() => _AddWithdrawalWidgetState();
}

class _AddWithdrawalWidgetState extends State<AddWithdrawalWidget> {
  late AddWithdrawalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddWithdrawalModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PortWithdrawalRecord>(
      stream: PortWithdrawalRecord.getDocument(widget!.title!),
      builder: (context, snapshot) {
        ...
        final containerPortWithdrawalRecord = snapshot.data!;
                      ...
                      Expanded(
                        child: TextFormField(
                          controller: _model.titleTextController ??=
                            ...
                            text: containerPortWithdrawalRecord.name,
                          ),
                    ...
                    children: [
                      ...
                      Flexible(
                        child: Align(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await WithdrawalRecord.collection
                                  .doc()
                                  .set(createWithdrawalRecordData(
                                    titre: widget!.title,
                                    ...
                                    titreString:
                                        containerPortWithdrawalRecord.name,
                                  ));
