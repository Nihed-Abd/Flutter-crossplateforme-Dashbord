                  ...
                  Expanded(
                    child: StreamBuilder<PortDepotRecord>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final titlePortDepotRecord = snapshot.data!;

                        return TextFormField(
                          controller: _model.titleTextController ??=
                              TextEditingController(
                            text: titlePortDepotRecord.name,
                          ),
                        ...
                        onPressed: () async {
                          await DepotRecord.collection
                              ...
                              .set(createDepotRecordData(
                                ...
                                remarque: _model.remarqueTextController.text,
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                title: Text('تهانينا'),
                                content: Text('تمت إضافة المداخيل بنجاح '),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
