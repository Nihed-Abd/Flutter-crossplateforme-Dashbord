...
import 'add_depot_model.dart';
export 'add_depot_model.dart';

class AddDepotWidget extends StatefulWidget {
  const AddDepotWidget({
    super.key,
    required this.title,
  });
  ...
  @override
  State<AddDepotWidget> createState() => _AddDepotWidgetState();
}

class _AddDepotWidgetState extends State<AddDepotWidget> {
  late AddDepotModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddDepotModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PortDepotRecord>(
      stream: PortDepotRecord.getDocument(widget!.title!),
      builder: (context, snapshot) {
        ...
        final containerPortDepotRecord = snapshot.data!;
                      ...
                      Expanded(
                        child: TextFormField(
                          controller: _model.titleTextController ??=
                            ...
                            text: containerPortDepotRecord.name,
                          ),
                    ...
                    children: [
                      ...
                      Flexible(
                        child: Align(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await DepotRecord.collection
                                  .doc()
                                  .set(createDepotRecordData(
                                    titre: widget!.title,
                                    ...
                                    titreString: containerPortDepotRecord.name,
                                  ));
                              ...
                              await HistoryRecord.collection
                                  ...
                                  .set(createHistoryRecordData(
                                    ...
                                    message:
                                        '${currentUserDisplayName}قام  بإضافة ${_model.titleTextController.text}كمداخيل جديدة',
                                  ));
                              await showDialog(
                                context: context,
