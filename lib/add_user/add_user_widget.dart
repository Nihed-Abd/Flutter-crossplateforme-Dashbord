                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          labelText: FFLocalizations.of(context)
                                              .getText(
                                            '2v2oyeu4' /* عنوان البريد الإلكتروني */,
                                          ),
                                          ...
                                          hintText: FFLocalizations.of(context)
                                              .getText(
                                            'gmfggtdp' /* عنوان البريد الإلكتروني */,
                                          ),
                                        ...
                                        onPressed: () async {
                                          ...
                                          await HistoryRecord.collection
                                              ...
                                              .set(createHistoryRecordData(
                                                ...
                                                message:
                                                    '${currentUserDisplayName}قام  بإضافة ${_model.passwordTextController1.text}كمستخدم جديد',
                                              ));
                                          await showDialog(
                                            context: context,
                                            builder: (alertDialogContext) {
                                              return AlertDialog(
                                                title: Text('تهانينا'),
                                                content: Text(
                                                    'تمت إضافة مستخدم جديد إلى الفريق'),
                                                actions: [
                                                  TextButton(
                                                    onPressed: () =>
                                                        Navigator.pop(
