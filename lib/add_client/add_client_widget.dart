...
class _AddClientWidgetState extends State<AddClientWidget> {
  ...
  void initState() {
    ...
    _model.passwordTextController5 ??= TextEditingController();
    _model.passwordFocusNode5 ??= FocusNode();

    _model.passwordTextController6 ??= TextEditingController();
    _model.passwordFocusNode6 ??= FocusNode();
  }
                                  ...
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        labelText:
                                            FFLocalizations.of(context).getText(
                                          'rr9oryud' /* رقم بطاقة الهوية الوطنية */,
                                        ),
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .bodySmall
                                            .override(
                                        ...
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'jbz8ktaf' /* رقم بطاقة الهوية الوطنية */,
                                        ),
                                        hintStyle: FlutterFlowTheme.of(context)
                                            .bodySmall
                                            .override(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: TextFormField(
                                      controller:
                                          _model.passwordTextController5,
                                      focusNode: _model.passwordFocusNode5,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText:
                                            FFLocalizations.of(context).getText(
                                      ...
                                      validator: _model
                                          .passwordTextController5Validator
                                          .asValidator(context),
                                    ),
                                  ),
                                ],
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: TextFormField(
                                      controller:
                                          _model.passwordTextController6,
                                      focusNode: _model.passwordFocusNode6,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText:
                                            FFLocalizations.of(context).getText(
                                          'paltop3p' /* مبلغ الاشتراك */,
                                        ),
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .bodySmall
                                            .override(
                                      ...
                                      keyboardType:
                                          const TextInputType.numberWithOptions(
                                              decimal: true),
                                      validator: _model
                                          .passwordTextController6Validator
                                          .asValidator(context),
                                    ),
                                  ),
                                ],
                                        ...
                                        onPressed: () async {
                                          await ClientRecord.collection
                                              ...
                                              .set(createClientRecordData(
                                                ...
                                                adresse: _model
                                                    ...
                                                    .text,
                                                montantCredit: double.tryParse(
                                                    _model
                                                        .passwordTextController5
                                                        .text),
                                                montantAbonnement:
                                                    double.tryParse(_model
                                                        .passwordTextController6
                                                        .text),
                                                nomComplete: _model
                                          ...
                                          await HistoryRecord.collection
                                              ...
                                              .set(createHistoryRecordData(
                                                ...
                                                message:
                                                    '${currentUserDisplayName}قام  بإضافة ${_model.passwordTextController1.text}كعميل جديد',
                                              ));
                                          await showDialog(
                                            context: context,
