                              ...
                              Container(
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    fit: BoxFit.cover,
                                    image: Image.asset(
                                      'assets/images/360_F_202179910_Uv0HNNaT1LklpUAwfC5eJY3QhGL2IkAc.jpg',
                                    ).image,
                                  ),
                                ),
                                child: Container(
                                  ...
                                  height:
                                      MediaQuery.sizeOf(context).height * 0.539,
                                  child: Stack(
                                    children: [
                                      Column(
                                        mainAxisSize: MainAxisSize.max,
                                                                      ...
                                                                      children: [
                                                                        Align(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            stream:
                                                                                UsersRecord.getDocument(listViewChatRecord.user!),
                                                                            builder:
                                                                                (context, snapshot) {
                                                                              // Customize what your widget looks like when it's loading.
                                                                              if (!snapshot.hasData) {
